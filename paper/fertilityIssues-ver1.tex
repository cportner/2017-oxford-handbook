...
\hypersetup{
            ...
            pdfauthor={Claus C Pörtner Department of Economics Albers
School of Business and Economics Seattle University, P.O.
Box 222000 Seattle, WA 98122 cportner@seattleu.edu www.clausportner.com
...
width\fi}
\def\maxheight{\ifdim\Gin@nat@height>\textheight\textheight\else\Gin@nat
@height\fi}
\makeatother
...
Figure {[}fig:TFR{]} shows that there has been an astonishing decline in
...
developed countries and there is rapid urbanization and increasing labor
force participation among women, does this Handbook even need a chapter
focused on fertility in developing countries? The goal of this chapter
is to highlight areas in which a separate focus on developing countries
is still relevant, what the recent developments in research has been,
and most importantly, what I consider to be the main outstanding issues.
The chapter is organized \ldots{}

\section{Sub-Saharan Africa}\label{sub-saharan-africa}

Both in terms of the degree of decline and the overall level, the
outlier in figure 1 is Sub-Saharan Africa.
...
other regions.
Figure {[}fig:mortality{]} shows the pattern in under-5 mortality across
the same regions as above over time.
The improvements in mortality risk over time are truly astonishing.
Over the last half-decade under-5 mortality in developing countries has
...
\section{Bargaining Power and Sex
Preference}\label{bargaining-power-and-sex-preference}
