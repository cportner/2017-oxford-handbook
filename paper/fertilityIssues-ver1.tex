...
The problem is that fertility only begins to decline at 
higher levels of education in Sub-Saharan Africa than
in other regions. 

See  \citet{Ainsworth1996}, \citet{Thomas1996}
...
effect on fertility as other found elsewhere \citet{Alam2016}.
...
An example is Ethiopia, where the overall TRF is TK, but that
covers a TFR of TK in rural areas and only TK in urban areas.
