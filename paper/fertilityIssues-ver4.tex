...
last half century.%
\footnote{
TFR is the number of children a woman entering her reproductive life
would have if her childbearing followed the current age-specific fertility
...
in research have been, and, most important, what I consider to be the
...
over girls that still exists in many developing countries. 
...
instead to both highlight how we can think about fertility decisions and
...
rates across the same regions as earlier over time.%
\footnote{
...
Over the last half century the mortality of children under the age of
...
Demographers, following the first approach described previously, have argued
...
I return later to how husband and wife decide on fertility if they do
...
land rights is in many countries controlled at the local level by
...
\footnote{
See also \citet{besley95c}, who discusses other investments in land that
can secure property rights.} 
The reason a lack of secure land rights can lead to higher birth rates is
...
land was distributed based on family size, but the northern part did not. 
...
Moving away from the pronatalist land distribution system is estimated
to reduce fertility by just over one child for rural households. 
These results suggest that security of land access is important,
...
than other regions.%
\footnote{
As shown by \citet{Oye2016}, this is not the same as saying that 
low-quality education has no impact on fertility, only that the effect of
...
effect on fertility in Tanzania as found elsewhere
\citep{Alam2016}.
...
different. 
A lower ``return'' to education could be an indication either that the
...
development), or that there is something inherently
...
The two subareas where we do have some information are the timing of
...
the later section below on sex preference.
...
access to a program that is believed to influence one of these decisions
...
This indicates that differences in desired number of children are
...
family wants.%
\footnote{
In India's National Family Health Surveys, and in Demographic
...
This is followed by the sex preference question: ``How many of these
...
than after the birth of a daughter 
\citep[see, e.g.,][]{Das1987,Arnold1997,clark00,filmer09}. 
...
daughter \citep[see, e.g.,][]{Das1987,Rahman1993,Pong1994,Haughton1996,Arnold1997}. 
...
\citet{Freedman1997}. 
\citet{Singh2012} provide recent estimates of the use of and need for
contraceptives in the developing world, together with the cost of providing
contraceptive services.} 
The lack of evidence is mainly the result of the challenges in measuring
family planning programs' impacts. 
...
Evidence from the United States indicates that better-educated women and
...
One example is a health scare in Zambia, where people were led to 
believe that injectable contraceptives contained HIV, resulting in 
a four-months national ban.
This coincided with a contraceptive access experiment and may have led 
to the very small estimated effect of the program on fertility \citep{Ashraf2009}.%
\footnote{
...
These results, however, reflect a level of program intervention and
...
planning see, for example, \citet{angeles98}.}
...
With this approach, a woman in Tanzania exposed to family planning
...
\citep{angeles98}.%
\footnote{
See also \citet{Angeles2005} on Indonesia and \citet{Angeles2005a} on
Peru.} 
...
results from Indonesia show that subsidizing contraceptive use by about half
...
educated the woman is \citep{Pop-Eleches2010}.} 
...
and is independent of the individual woman's initial demand for
contraception.
...
\citep{Salas2014}. 
Both supply reductions and swings in the supply of contraceptives led
...
sterilization, which reportedly involved bribes and coercion, initiated by
...
The Matlab experiments described previously contribute most of the credible
...
suggesting no significant differences in height for children younger than
...
Treated women with more education at the beginning of the program were more
likely to live in higher-valued homesteads; own more agriculture,
...
these inputs combine to produce a child and his or hers traits. 
...
opportunities, there were an increases in human capital investments for
...
driven by better knowledge about health rather than higher income,
...
women and if women prefer to have fewer children than men do, this would
reduce fertility.%
\footnote{
\citet{Ainsworth1996} review other potential explanations.}

\section{Conclusion}\label{conclusion}

As this chapter has shown, most developing countries have experienced a
...
Furthermore, Sub-Saharan Africa has not experienced as strong a decline
...
And third, how do sex preferences affect fertility outcomes? 
...
although the trade-off is often that only relatively short-term outcomes
are examined.
...
The caveat is that the reductions in question---between half and one
...
\bibliography{oxford-references}
